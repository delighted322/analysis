...
// TODO: 跑数据库里的绘本 四千多条 质性的框没有分
var fs = require("fs");
var YAML = require("yaml");
var utils = require("./utils/utils");
var title = "O-Lib-Total-book_text_data-2020-11-19";
...
for (var i = 0; i < jsonFile.length; i++) {
    ...
    if (q.type == "绘本（包含漫画）") {
        ...
        wL[0], // 字词难度
        sL[2], // 句子难度
        q.theme, q.structure, q.languageFeature, q.backgroundKnowledge, 0.4, // 篇幅权重        // TODO:
        0.2, // 不重复字总数权重
        0.2, // 字词难度权重
        0.2, // 句子难度权重,
        0, // 主题权重
        ...
        wL[0], // 字词难度
        sL[2], // 句子难度
        q.theme, q.structure, q.languageFeature, q.backgroundKnowledge, 0.2, // 篇幅权重
        0.1, // 不重复字总数权重
        0.1, // 字词难度权重
        0.1, // 句子难度权重,
        0.1, // 主题权重
